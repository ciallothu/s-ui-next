...
This directory contains all Windows-specific files for S-UI Next.

## Available Files:

- **s-ui-next-windows.xml**: Windows Service configuration
- **install-windows.bat**: Installation script
- **s-ui-next-windows.bat**: Control panel
...
To install S-UI Next on Windows:
1. Run `install-windows.bat` as Administrator
2. Follow the installation wizard
3. Use `s-ui-next-windows.bat` for management
